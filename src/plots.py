    ...
    for n, p in enumerate(plots):
        ...
        if p['title'] == 'Flow cumulants':
            ...
            p.update(
                ylabel=r'$v_n\{k\}$',
                subplots=[
                    ('vnk', nk, dict(label=r'$v_{}\{{{}\}}$'.format(*nk)))
...
def validation_all(system='PbPb5020'):
    ...
    def label(obs, subobs):
        ...
        if obs in id_parts_labels:
            return r'${}\ {}$'.format(
                id_parts_labels[obs],
                {'pion': r'\pi', 'kaon': 'K', 'proton': 'p'}[subobs]
            )
...
def diag_emu(system=default_system):
    ...
    """
    if system == '' or system == None: system = default_system
...
if __name__ == '__main__':
    ...
    class CustomSyntaxWarning(SyntaxWarning):
        pass

    warnings.filterwarnings(
        'ignore',
        category=CustomSyntaxWarning,
